...
def startCompiler():
    ...
    while isCompiling:
        ...
        #         isPiDataReaded = True
        #     except:
        #         print("Failed Reading Of PiCompiled Trying Again")
        # isPiDataReaded = False
        ...
        while not isProcess5DataReaded:
            try:
                ...
                print("Failed Reading Of Process5 Trying Again")
        isProcess5DataReaded = False
...
def startApplication():
    #Starting Thread
    threading.Thread(target=startCompiler).start()
...
#Button
compileButton = tk.Button(root, text='COMPILE', font=("Arial", 12), command = startApplication, width=15, height=1)
